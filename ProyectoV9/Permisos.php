	...
	<body>
		...
		<!-- Wrapper -->
				...
				<!-- Main -->
					   ...
					   if(isset($Sub)){
					   	if(trim($numero)=="" || trim($nombre)=="" || trim($apellido)=="" || trim($Rol)=="" || trim($passwrd)=="" || trim($correo)==""){
                            ...
                            print '</script>';
                            	...
                            	$Rel = $_POST['Rol'];
                            if($Rel==0){
                            	$query = mysqli_query($conexion,"INSERT INTO Usuarios (Name, UserPassword, Email, NoEmpleado, Apellido, mae, Status, sup, adm) VALUES ('$nombre', '$passwrd', '$correo', '$numero', '$apellido', 1, 1, 0, 0)");
                            }
                            if($Rel==1){
                            	$query = mysqli_query($conexion,"INSERT INTO Usuarios (Name, UserPassword, Email, NoEmpleado, Apellido, adm, Status, mae, sup) VALUES ('$nombre', '$passwrd', '$correo', '$numero', '$apellido', '$Rol', 1, 1, 0)");
                            }
                             if($Rel==2){
                            	$query = mysqli_query($conexion,"INSERT INTO Usuarios (Name, UserPassword, Email, NoEmpleado, Apellido, mae, sup, Status, adm) VALUES ('$nombre', '$passwrd', '$correo', '$numero', '$apellido', 1, 1, 1, 0)");
                            }
				    ...
				    ?>
						...
						?>
								 ...
								 if($pressed==1){
                                    ...
                                    //Modificando en bd
                                      $conexionmodif = mysqli_connect("www.geoconstructor.com","geoconst_admin","permisosuabc1584","geoconst_PermisosUABC");
			                           mysqli_query($conexionmodif,"UPDATE Usuarios SET NoEmpleado='$elnumero', Name= '$elnombre', Apellido= '$elapellido', UserPassword='$elpass', mae= '$elmaestro', adm='$eladm', sup='$elsup' WHERE Email='".$elmail."' ");
								...
								<section>
									<a href="generic.html" class="image">
										<img src="images/img5.jpg" alt="" data-position="top center" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
			...
			for($i=0; $i<$aux; $i++){
						...
						if($resultadot['sup']==0 && $resultadot['mae']==1){
							echo"<tr>";
							echo"<td>" . $resultadot['NoEmpleado'] . "</td>";
							echo"<td>" . $resultadot['Name'] . "</td>";
							echo"<td>" . $resultadot['Apellido'] . "</td>";
