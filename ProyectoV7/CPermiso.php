			                   ...
			                   $dateL ='2018-'.$mesL.'-'.$diaL;
                                ...
                                if(validateDate($dateS, 'Y-m-d')){
                                	if(validateDate($dateL,'Y-m-d')){
                                        $quer = mysqli_query($revisar,"INSERT INTO Solicitud (Nombre,NoEmpleado,NombreEvento,Lugar,Costos,HoraSalida,HoraLlegada,Carrera,OficioComision,ActAsociada,NumeroAlumnos,FechaSalida,FechaLlegada) VALUES('$nombreS','$numeroS','$NE','$LE','$Costos','$THS','$HL','$Carrera','$OficioComision','$ActAsociada','$NoAlumnos','$dateS','$dateL')");
